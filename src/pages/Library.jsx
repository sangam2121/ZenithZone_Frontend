      ...
      <div className='w-[60%] mx-auto gap-3'>
        <div class="flex items-start gap-2.5 mb-5">
          ...
          <div class="flex flex-col gap-2.5">
            ...
            <div class="leading-1.5 flex w-[700px] flex-col">
              <div class="flex items-start bg-gray-50 dark:bg-gray-700 rounded-xl p-2">
                ...
                <div class="inline-flex self-center items-center ml-auto">
        ...
        <div class="flex items-start gap-2.5 mb-5">
          ...
          <div class="flex flex-col w-[700px] leading-1.5">
            <div class="flex items-center space-x-2 rtl:space-x-reverse">
              <span class="text-sm font-semibold text-gray-900 dark:text-white">Bonnie Green</span>
              <span class="text-sm font-normal text-gray-500 dark:text-gray-400">11:46</span>
            </div>
        ...
        <div class="flex items-start gap-2.5">
          ...
          <div class="flex flex-col gap-1">
            ...
            <div class="flex flex-col w-[400px] leading-1.5 py-2 rounded-e-xl rounded-es-xl">
              <div class="flex items-center space-x-2 rtl:space-x-reverse">
