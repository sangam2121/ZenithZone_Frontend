  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const clinicResponse = await fetch(
        `${import.meta.env.VITE_AUTH_BASE_URL}/doctor/clinics/`,
        {
          method: 'POST',
          body: clinicData,
          headers: {
      ...
      if (!clinicResponse.ok) {
        throw new Error('Failed to update clinic details');
      }
      ...
      profileData.append('name', profile.clinic_name);
      profileData.append('address_lat', address.lat);
      profileData.append('address_lon', address.lon);
          ...
          <form method='post' encType='multipart/form-data' onSubmit={handleSubmit}>
            ...
            {step === 4 && (
              <>
                ...
                <div className="grid md:grid-cols-2 md:gap-6">
                  <div className="relative z-0 w-full mb-5 group">
                    <input type="text" name="clinic_name" id="floating_clinic_name" className="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " onChange={handleProfileChange} />
