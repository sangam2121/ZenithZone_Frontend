        ...
        <div class='w-[1200px] mx-auto flex justify-between h-[90vh] px-12'>
            <div class='w-[1/2] flex flex-col justify-center text-left '>
                ...
                <div class='flex gap-5'>
                    <button className="rounded-[30px] bg-[#FEEEE9] text-[#F05423] md:px-5 md:py-2 px-3 py-1">Read more</button>
                    <button className="rounded-[30px] bg-[#121F49] text-[white] md:px-5 md:py-2 px-3 py-1">Book a Psychiatrist</button>
                </div>
            </div>
            <div class='w-[1/2]'>
