...
const contactUpdate = ({ onClose }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            clinicData.append('appointment_fee', clinic.appointment_fee)
            clinicData.append('name', clinic.clinic_name);
            clinicData.append('address_lat', address.lat);
            clinicData.append('address_lon', address.lon);
            const clinicResponse = await fetch(`${import.meta.env.VITE_AUTH_BASE_URL}/doctor/update/${localStorage.getItem("userId")}/`, {
                method: 'PUT',
                body: clinicData,
                headers: {
